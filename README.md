...
Compilador web para uma linguagem simples de gestão escolar, desenvolvido em Python com Flask para a disciplina de ***Compiladores***.
...
CONSULTAR NOTAS numero_matricula
